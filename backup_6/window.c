...
static GLuint _pId_transition, _pId_sable ,_pId_TV, _pId_blanc ,_pId_rouge , _pId_blanc2 , _pId_blancObstacle , _pId_lave
=0;
...
static float _rotaX_camera = 180; //pencher 
*/
...
static void init(void) {
  ...
  _pId_noir  = gl4duCreateProgram("<vs>shaders/basic.vs", "<fs>shaders/basic_noir.fs", NULL);
  ...
  _pId_sable = gl4duCreateProgram("<vs>shaders/basic.vs", "<fs>shaders/basic_sable.fs", NULL);
  ...
  _pId_blanc2 = gl4duCreateProgram("<vs>shaders/basic.vs", "<fs>shaders/basic_blanc2.fs", NULL);

  _pId_blancObstacle = gl4duCreateProgram("<vs>shaders/basic.vs", "<fs>shaders/basic_blancObstacle.fs", NULL);

   _pId_rouge= gl4duCreateProgram("<vs>shaders/basic.vs", "<fs>shaders/basic_rouge.fs", NULL);
  
  _pId_lave = gl4duCreateProgram("<vs>shaders/basic.vs", "<fs>shaders/basicLAVE.fs", NULL);
  
  
  _pId_multicolore = gl4duCreateProgram("<vs>shaders/basic.vs", "<fs>shaders/basic_multicolore.fs", NULL);
...
glUseProgram(_pId_lave);
  ...
  glUniform1f(glGetUniformLocation(_pId_lave, "temps"), _temps *2 );
