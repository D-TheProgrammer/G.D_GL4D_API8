...
/* SEQUENCE 3 teleportation */
  ...
  glUniform1f(glGetUniformLocation(_pId_multicolore, "zoom"), _zoom);
  glUniform1f(glGetUniformLocation(_pId_multicolore, "temps"), _temps);

  gl4duTranslatef(8250.0f,   7920.0f, 8247.0f);
  gl4duScalef(0.1 + a0/50 +, 0.1f + a0/50, 2.0f);
